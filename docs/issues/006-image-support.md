...
**優先度**: 中
**ステータス**: 部分的に実装済み（テキスト・画像・URL対応完了）
...
### データ管理
- [x] ローカルストレージに保存（現在UserDefaults、FileManager移行予定） 🚧
- [ ] キャッシュ管理（古い画像の自動削除）
- [ ] 最大ストレージサイズの制限
- [ ] 圧縮オプション
...
- [x] 画像のコピー＆保存 ✅（実装完了、実機テスト待ち）
- [x] スクリーンショットの自動保存 ✅（実装完了、実機テスト待ち）
- [x] サムネイル生成 ✅（実装完了）
- [x] 画像プレビュー ✅（実装完了）
- [x] URLのコピー＆保存 ✅（実装完了、実機テスト待ち）
- [x] ファイルサイズ表示 ✅（実装完了）
- [ ] フィルタ機能
- [ ] ストレージ上限の動作
- [ ] メモリ警告時の動作
